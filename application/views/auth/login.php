...
<div class="row justify-content-center mt-5 pt-lg-5">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="text-center mb-4">
                                <h1 class="h4 text-gray-900">Sistem Informasi Pengadaan</h1>
    ...
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span style="color:white;font-size:12px;">Copyright &copy; Sistem Informasi Pengadaan Barang | IT Yayasan Diannanda 2023</span>
        </div>
    </div>
