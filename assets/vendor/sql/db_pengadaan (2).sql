...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2024 at 10:22 AM
...
CREATE TABLE `pengadaan` (
  ...
  `status_pengadaan` varchar(35) NOT NULL,
...
(14, 'doni', 'doni', 'yys', 'yys', 'admin', '$2y$10$TLWyJK2HZOvzuf6DFTqXce4Gim6MgwGpjCsd61QDUHsauXm8a87Sq', 1686095893, 'user.png', 1, NULL),
...
(47, 'Florencia Devi ', 'yys', 'yys', 'yys', 'yys', '$2y$10$oeSrntV9fSVsInNQnZtjS.3QUcHlPvIu/zg7Z7oglGUJL/K2lOvvC', 1728742769, 'user.png', 1, 'donydonny4@gmail.com'),
...
(52, 'Christina Minarti', 'kepsektk1', 'kepsek', 'tk1', 'kepsek', '$2y$10$r8JdTyNrJgzAd1G4tqRxu.J1VD8N4SXPt4iZwvcMNPl10cVivwfJq', 1730254042, 'user.png', 1, '-'),
(53, 'Elisabet Setyo Sri', 'kepsektk2', 'kepsek', 'tk2', 'kepsek', '$2y$10$.VQvFXJUH2mpG8UFraLDa.iFcyh/cRtQ0.LuOSgXuDKcoEPhVvg76', 1730254106, 'user.png', 1, '-'),
(54, 'Petrus Laritmas', 'kepseksmp1', 'kepsek', 'smp1', 'kepsek', '$2y$10$LTkWQBxkkfuU36h4dMxhlOXP5hoPUCm9G4lFl9kaT3YJVw6gyrcRK', 1730254166, 'user.png', 1, '-'),
(55, 'Vitus Modestus Suyanta', 'kepseksmp2', 'kepsek', 'smp2', 'kepsek', '$2y$10$cT75YDel12kTL33Hv14x2eEQt4NNuKrUZtrIl6SzgGqfms2kaE3tu', 1730254215, 'user.png', 1, '-'),
(56, 'Alfonsus Sapto Utomo', 'kepseksd1', 'kepsek', 'sd1', 'kepsek', '$2y$10$jvxOIPAtsVqF5MxxnHCVZ.WW1ILWsG3BbVOyZ9fyc0.JNp9zvo4ZK', 1730254297, 'user.png', 1, '-'),
(57, 'Agustinus Paryono', 'kepseksd2', 'kepsek', 'sd2', 'kepsek', '$2y$10$VRbthyeCftjcbdAdepnydu6u9tcgSaoMX3UnLyGuxXOcA167EewTC', 1730254380, 'user.png', 1, '-'),
(58, 'F. X. Sri Wahyudi', 'kepseksma1', 'kepsek', 'sma1', 'kepsek', '$2y$10$nD6H7MXMncKk9PTTToZoau7mdiqxGFtL6ueGzHAXXTkVRQS8FQieK', 1730254426, 'user.png', 1, '-'),
(59, 'A.G Tri Yudianto', 'kepseksma2', 'kepsek', 'sma2', 'kepsek', '$2y$10$exHiTeos4w9toYgDJfWXEu83zS9HaN6VHWwkPkDQMa.76mhU5cs42', 1730254469, 'user.png', 1, '-');
